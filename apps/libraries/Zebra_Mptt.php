...
//            trigger_error('<br>No MySQL connection!<br>Error', E_USER_ERROR);
    ...
    $connection = @mysqli_connect($this->data['host'], $this->data['username'], $this->data['password'], $this->data['database']);
        ...
        if (
            ...
            mysqli_query($connection, 'LOCK TABLE ' . $this->properties['table_name'] . ' WRITE');
        ...
        if (
            ...
            foreach ($sources as $id => &$properties) {
                ...
                mysqli_query($connection, '
                    ...
                    VALUES
                        (
                            "' . mysqli_real_escape_string($connection, $properties[$this->properties['title_column']]) . '",
