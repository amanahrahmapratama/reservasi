...
class Media_manager_admin extends CI_Controller {
    ...
    public function index($offset = 0) {
        ...
        $config['base_url'] = site_url('admin/media_manager/index/');
        $config['total_rows'] = $data['total_images'];
        $config['per_page'] = 16;

        $this->pagination->initialize($config);
        $data['title'] = 'Media manager';
        $data['page'] = 'media_manager/list';
    ...
    public function upload() {
        ...
        if ($this->input->post('id')) {
            redirect('admin/media_manager/album/' . $this->input->post('id'));
        } else {
            redirect('admin/media_manager');
        }
    }
    ...
    public function popup($keyword = '', $offset = 0) {
        ...
        //$this->load->view('admin/media_manager/popup', $data);
        /*
         * Rewrite
         */
        $data = array();
    ...
    public function listAjax($offset = 1, $isfile = 0) {
        ...
        $config['base_url'] = site_url('admin/media_manager/popup/');
        $config['total_rows'] = $data['total_images'];
        $config['per_page'] = $this->Mediamanager_model->limit;
