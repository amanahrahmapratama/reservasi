    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <span class=" pull-right">
                <a href="<?php echo site_url('admin/posts') ?>" class="btn btn-info"><span class="ion-arrow-left-a"></span>&nbsp; Kembali</a> 
            <a href="<?php echo site_url('admin/posts/edit/'.$posts['posts_id']) ?>" class="btn btn-warning"><span class="ion-edit"></span>&nbsp; Edit</a> 
            </span>
        </div>
    </div><br>
    <div class="row">
