					...
					<div class="single-post row">
						<div class="col-lg-12">
							<div class="feature-img">
								<img class="img-fluid" src="<?php echo base_url('uploads/'.$posting['posting_image']) ?>" alt="">
							</div>
						</div>
						<div class="col-lg-3  col-md-3 meta-details">
							<ul class="tags">
								<li><a href="#"><?php echo $posting['posting_category_name']; ?></a></li>
							</ul>
						...
						<div class="col-lg-9 col-md-9">
							<a class="posts-title" href="#"><h3><?php echo $posting['posting_title'] ?></h3></a>
							<?php echo $posting['posting_desc'] ?>
						</div>
					</div>
				</div>
