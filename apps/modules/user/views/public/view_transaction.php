	...
	<div class="blog__content mb-72">
		<div class="row">
			...
			<div class="col-md-9">
				<div class="card mb-4">
					<div class="card-body">
						<h4 class="card-table"><?php echo $title; ?></h4>
						<div class="table-responsive">
							<table class="table">
								...
								<tr>
									<td>Total Harga</td>
									<td><?php echo idr_format($sale['sale_total_price']) ?></td>
								</tr>
								<tr>
									<td>Status</td>
									<td>
										<?php if ($sale['sale_status_sale_status_id'] == 1): ?>
											<span class="badge badge-danger">Menunggu ongkos kirim</span>
										<?php elseif ($sale['sale_status_sale_status_id'] == 2): ?>
											<span class="badge badge-warning">Menunggu pembayaran</span>
										<?php elseif ($sale['sale_status_sale_status_id'] == 3): ?>
											<span class="badge badge-secondary">Pending payment verification</span>
										<?php elseif ($sale['sale_status_sale_status_id'] == 4): ?>
											<span class="badge badge-primary">Pembayaran dikonfirmasi</span>
										<?php elseif ($sale['sale_status_sale_status_id'] == 5): ?>
							...
							<table class="table">
								...
								<tbody>
									...
									<tr>
										...
										<td><?php echo idr_format($sale['sale_ongkir']) ?></td>
									</tr>
									<tr>
										<td colspan="3"><strong>Total</strong></td>
										<td><strong><?php echo idr_format($count+$sale['sale_ongkir']) ?></strong></td>
									</tr>
								</tbody>
							</table>
						</div>
				...
				<?php if ($sale['sale_status_sale_status_id'] == STATUS_WAITING_PAYMENT): ?>
					<div class="card mb-4">
						<div class="card-body">
						...
						<div class="card-body">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<button class="btn btn-lg btn-color"><span>Konfirmasi</span></button>
									<?php form_close(); ?>
								</div>
								...
								<div class="col-md-6">
									<div class="alert alert-info" role="alert">
										...
										<hr>
										<p>
											Kami akan menginformasikan bahwa pembayaran Anda telah di terima oleh Portal BUMDes melalui email “Konfirmasi Payment Approval”
											atau Anda dapat melihat melalui halaman order tracking yang terdapat di home page website Portal BUMDes. Bila dalam 1 x 24 jam (terhitung pada hari kerja) Anda tidak mendapat informasi tersebut,
