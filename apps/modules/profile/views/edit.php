...
<div class="row">
    ...
    <div class="row">
        <div class="col-sm-9 col-md-9">
            ...
            <input name="user_name" type="text" readonly placeholder="Username" class="form-control" value="<?php echo $inputNameValue; ?>"><br>
            ...
            <?php if (!isset($user)): ?>
                ...
                <input type="password" placeholder="Password" name="userpassword" class="form-control"><br>
            ...
            <p style="color:#9C9C9C;margin-top: 5px"><i>Contoh : example@yahoo.com / example@example.com</i></p><br>
            ...
            <div class="form-group">
                ...
                <?php if (isset($user)): ?>
                    <?php if ($this->session->userdata('user_id_admin') != $id) {
                        ?>
                        <a style="margin-top: 3px" href="<?php echo site_url('admin/user/delete/' . $user['user_id']); ?>" class="btn btn-danger"><i class="ion-trash-a"></i> Hapus</a>
                    <?php } ?>
                        <a href="<?php echo site_url('admin/profile/cpw') ?>" class="btn btn-primary" style="margin-top: 3px"><i class="ion-refresh"></i> Ubah password</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
