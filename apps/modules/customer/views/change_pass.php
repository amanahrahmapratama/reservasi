		...
		<div class="grid simple ">
			<div class="grid-body no-border">
				...
				<div class="form-group">
					...
					<input type="password" name="customer_password" class="form-control" placeholder="Password Baru">
					<?php if($this->uri->segment(3) == 'cpw' ) { ?>
				...
				<a href="<?php echo site_url('admin/customer'); ?>" class="btn btn-info"><i class="ion-arrow-left-a"></i> Batal</button></a>
				<?php form_close() ?>
